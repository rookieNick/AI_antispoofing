...
def import_image():
    ...
    if file_path:
        ...
        try:
            ...
            # Predict using controller
            label = get_prediction_label(img)
...
def launch_ui():
    global root, result_output, webcam_label, image_canvas, start_combined_button, import_image_button
    root = tk.Tk()
    ...
    # Import Image Button above results on right
